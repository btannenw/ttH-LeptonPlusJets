...
#config.General.requestName = 'preApproval2017_v2_DoubleMuon-Run2017F-31Mar2018-v1' ## change//Name of the directory that crab will create
config.General.requestName = 'preApproval2017_v2_DoubleEG-Run2017F-31Mar2018-v1_missingLumis' ## change//Name of the directory that crab will create
...
config.Data.inputDataset =  '/DoubleEG/Run2017F-31Mar2018-v1/MINIAOD' # DoubleEl, period B
config.Data.lumiMask = 'crab_preApproval2017_v2_DoubleEG-Run2017F-31Mar2018-v1/results/notFinishedLumis.json'
...
### change user Space 
#config.Data.outLFNDirBase = '/store/group/lpctthrun2/preApproval2017/DoubleMuon/'
