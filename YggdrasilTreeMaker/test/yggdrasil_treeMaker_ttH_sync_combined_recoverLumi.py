...
# 2018 ttH sync exercise 
  ...
  #root://cms-xrd-global.cern.ch///store/data/Run2017B/MuonEG/MINIAOD/31Mar2018-v1/100000/703683C0-4437-E811-A955-0025904B871E.root'
        #'file:///afs/cern.ch/work/b/btannenw/ttH/yggdrasil2018/triggerEff/localUpdates/gridSubmits_2017PreApproval/CMSSW_9_4_9/src/ttH-LeptonPlusJets/YggdrasilTreeMaker/test/302BF9DB-8537-E811-BF13-6CC2173DC2E0.root'
        cms.untracked.vstring( *inputDatafileList)
        )#,
                            #firstRun = cms.untracked.uint32(299316),
                            #firstEvent = cms.untracked.uint32(15450079)
)
