// wget https://raw.githubusercontent.com/cms-sw/cmssw/CMSSW_10_0_X/CondTools/BTau/test/BTagCalibrationStandalone.cpp

//#include "BTagCalibrationStandalone.h" // core
#include "ttH-LeptonPlusJets/YggdrasilTreeMaker/interface/BTagCalibrationStandalone.h" // BBT, 11-03-18
#include <iostream>
#include <exception>
#include <algorithm>
#include <sstream>
